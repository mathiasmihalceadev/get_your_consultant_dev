...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; background: #2A2755; color: #fff; padding: 3px 10px; border-radius: 4px; font-size: 12px; font-weight: 600; }
...
<body>
    <div class="container">
        ...
        <p>{{ $trans['email_status_link'] ?? 'You can also check your report status at:' }}<br>
